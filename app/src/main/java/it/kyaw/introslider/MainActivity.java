...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introPre = new IntroPre(this);
        if (!introPre.isFirstTimeLaunch()) {
            launchHomeScreen();
            finish();
        }
...
//                    launchHomeScreen();
                    startActivity(new Intent(MainActivity.this, LayfictoneMainActivity.class));
                    finish();
                }
            }
        });
...
//                    launchHomeScreen();
    ...
    private void launchHomeScreen() {
        introPre.setIsFirstTimeLunch(false);
